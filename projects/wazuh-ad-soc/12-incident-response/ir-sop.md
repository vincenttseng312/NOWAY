...
related_docs: [doc-severity-classification, doc-alert-to-report-pipeline, doc-ai-remediation-block]
mitre_attack: []
wazuh_sources: []
windows_event_ids: []
risk_level: ""
...
本專題的事件回應標準流程。各情境頁的「建議處置」與 [[doc-ai-remediation-block]] 都應對齊本 SOP。**屬防禦性流程；實際授權、工具、聯絡窗口為 env-specific。**
...
## 相關文件
[[doc-severity-classification]]、[[doc-alert-to-report-pipeline]]、[[doc-ai-remediation-block]]；跨連父層 [[persistence-mechanisms]]、[[ioc-ttp-and-detection-engineering]]。
